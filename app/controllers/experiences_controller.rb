class ExperiencesController < ApplicationController
  ...
  def index
    @experiences = Experience.all.paginate(:page => params[:page], :per_page => 4)
  end
  ...
  private
    ...
    def experience_params
      params.require(:experience).permit(:name_proyect, :image1, :image2, :image3, :image4, :url, :client, :description, :functionalitie)
    end
end
